...
enum clnt_stat 
set_value_1(struct arg_set_value a1, int *clnt_res,  CLIENT *clnt)
{
	return (clnt_call(clnt, set_value,
		(xdrproc_t) xdr_arg_set_value, (caddr_t) &a1,
		(xdrproc_t) xdr_int, (caddr_t) clnt_res,
		TIMEOUT));
}
...
enum clnt_stat 
modify_value_1(struct arg_set_value a2, int *clnt_res,  CLIENT *clnt)
{
	return (clnt_call(clnt, modify_value,
		(xdrproc_t) xdr_arg_set_value, (caddr_t) &a2,
		(xdrproc_t) xdr_int, (caddr_t) clnt_res,
		TIMEOUT));
}
