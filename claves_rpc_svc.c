...
int
_set_value_1 (struct arg_set_value  *argp, void *result, struct svc_req *rqstp)
{
...
int
_modify_value_1 (struct arg_set_value  *argp, void *result, struct svc_req *rqstp)
{
...
{
	union {
		struct arg_set_value set_value_1_arg;
		int get_value_1_arg;
		struct arg_set_value modify_value_1_arg;
...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, CLAVES, CLAVES_VER, claves_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (CLAVES, CLAVES_VER, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, CLAVES, CLAVES_VER, claves_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (CLAVES, CLAVES_VER, tcp).");
		exit(1);
	}
